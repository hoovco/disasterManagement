...
public class HttpServlet extends javax.servlet.http.HttpServlet {
    ...
    //need to write within this function//
    ...
    private void createReport(HttpServletRequest request, HttpServletResponse
        ...
        String sql;
        System.out.println("(HttpServlet):   in createReport() Line 78 ");
        ...
        if (contact_fN != null && contact_lN != null) {
            ...
            sql = "insert into person (first_name, last_name, telephone, email) " +
                    ...
                    + contact_email + ")";
            System.out.println("(HttpServlet): in createReport() sql" + sql);
            dbutil.modifyDB(sql);
        ...
        System.out.println("(HttpServlet): building insert statement");
        ...
        System.out.println("(HttpServlet): calling modifyDB");
        dbutil.modifyDB(sql);
        System.out.println("(HttpServlet): modifyDB successful");

        // response that the report submission is successful
        System.out.println("(HttpServlet): creating JSON");
        JSONObject data = new JSONObject();
        try {
            System.out.println("(HttpServlet): calling data.put");
            data.put("status", "success");
            System.out.println("(HttpServlet): successful through 192");
        } catch (JSONException e) {
            System.out.println("(HttpServlet): catch found at 195");
            e.printStackTrace();
            System.out.println("(HttpServlet): catch at 197");
        }
        System.out.println("(HttpServlet): writing data to string");
        response.getWriter().write(data.toString());
        System.out.println("(HttpServlet): .tostring successful 201");
